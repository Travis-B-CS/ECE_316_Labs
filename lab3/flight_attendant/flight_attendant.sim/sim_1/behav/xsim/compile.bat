...
REM
REM Generated by Vivado on Wed Mar 04 15:21:13 -0600 2026
...
echo "xvlog --incr --relax -prj tb_flight_attendant_vlog.prj"
call xvlog  --incr --relax -prj tb_flight_attendant_vlog.prj -log xvlog.log
