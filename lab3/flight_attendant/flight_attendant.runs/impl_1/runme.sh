...
HD_PWD='C:/Users/4trav/Desktop/ECE_Labs/ECE_316_Labs/lab3/flight_attendant/flight_attendant.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log flight_attendant.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source flight_attendant.tcl -notrace
