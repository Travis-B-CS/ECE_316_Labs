...
HD_PWD='C:/Users/4trav/Desktop/ECE_Labs/ECE_316_Labs/lab3/flight_attendant/flight_attendant.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log flight_attendant.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source flight_attendant.tcl
