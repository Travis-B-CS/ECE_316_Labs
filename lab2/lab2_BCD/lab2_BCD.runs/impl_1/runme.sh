...
HD_PWD='C:/Users/4trav/Desktop/ECE_Labs/ECE_316_Labs/lab2/lab2_BCD/lab2_BCD.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log bcd_to_7seg.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source bcd_to_7seg.tcl -notrace
